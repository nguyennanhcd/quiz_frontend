...
export default function QuizForm() {
  return (
    <div className='min-h-screen w-full text-foreground p-4 sm:p-6 md:p-8 bg-white dark:bg-transparent'>
      <Tabs defaultValue='quiz-details' className='w-full '>
        ...
        <TabsList className='grid w-full grid-cols-3 bg-[#f5f5f5] dark:bg-main'>
          <TabsTrigger
            value='quiz-details'
            className=' text-sm font-semibold data-[state=active]:bg-default data-[state=active]:text-white transition-transform'
          >
            Quiz Details
          </TabsTrigger>
          <TabsTrigger
      ...
      <div className='flex flex-col sm:flex-row items-center justify-between p-6 bg-transparent  gap-4 text-foreground'>
        <div className='flex flex-wrap gap-3'>
          <Button className='bg-transparent dark:hover:bg-slate-800 border border-gray-300 dark:border-slate-700 text-foreground px-4 py-2 rounded-md'>
        ...
        <div className='flex flex-wrap gap-3'>
          ...
          <Button className='bg-transparent dark:hover:bg-slate-800 text-foreground px-4 py-2 rounded-md border border-gray-300 dark:border-slate-700'>
