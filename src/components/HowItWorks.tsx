      ...
      <div className='container p-4 md:p-6'>
        <div className='flex flex-col items-center justify-center space-y-4 text-center mt-10'>
          <div className='space-y-2'>
            <div className='inline-block rounded-lg bg-[#e2e8f0] dark:bg-slate-600 px-3 py-1 text-sm text-foreground'>
              Simple Process
            </div>
        ...
        <div className='flex items-center justify-center flex-col space-y-4'>
          ...
          <div className='flex justify-center items-center gap-2 bg-main dark:bg-slate-900 border border-gray-300 dark:border-slate-700 px-4 py-2 rounded-xl'>
